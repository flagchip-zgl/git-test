...
#define FLS_FLASH_TYPES_SW_PATCH_VERSION             5
/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
...
typedef struct
{
    volatile uint32_t * pSectorStartAddressPtr; /**< @brief FLASH physical sector start address */
    uint32_t u32SectorId;    /**< @brief corresponding number in sector location to calc cfgCRC */
...
*                 .
*/ 
typedef unsigned long Fls_CompHandlerReturnType;
